        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('leveranciers.store') }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <select name="leveranciertype" 
                                ...
                                @foreach(\App\Models\Leverancier::LEVERANCIERTYPE_OPTIONS as $value => $label)
                                    <option value="{{ $value }}" {{ old('leveranciertype') == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
